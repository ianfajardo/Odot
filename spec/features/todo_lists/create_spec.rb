...
describe "Creating todo lists" do 
  ...
  it "displays an error when the todo list has a title less no characters" do
    expect(TodoList.count).to eq(0)
  ...
  it "displays an error when the description list has a title less than 5 characters" do
    expect(TodoList.count).to eq(0)
